 ...
 */
/*
ihpleD Copyright (C) 2014 <copyright holders>.
The software uses jquery.jqplot.js.And Released under the MIT license
*/
(function($) {
    ...
    function jqPlot() {
        ...
        this.draw = function(){
            if (this.drawIfHidden || this.target.is(':visible')) {
                ...
                ax.xaxis.pack({position:'absolute', bottom:this._gridPadding.bottom - ax.xaxis.getHeight(), left:0, width:this._width + 10}, {min:this._gridPadding.left, max:this._width - this._gridPadding.right});
