  ...
  /**
    ...
    baidu.object.extend(InfoBox.prototype,{
        ...
        _getCloseIcon: function(){
            var img = "<img id = 'infoBoxClose' src='" + this._opts.closeIconUrl + "' align='right' style='cursor:pointer; position:relative;right:0px;cursor:pointer;margin:" + this._opts.closeIconMargin + "'/>";
            return img;
        },
        /**
	     * 设置infoBox的内容
        ...
        _setContent: function(content){
	        ...
	        if(typeof content.nodeType === "undefined"){
	            this._div.innerHTML = content + closeHtml;
	        }else{
        ...
        _addEventToClose: function(){
            var me = this;
            baidu.event.on(this._div.lastChild, "click", me._closeHandler());
